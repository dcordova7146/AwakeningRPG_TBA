...
public class Runner {
	...
	public static void main(String[] args) {
		...
		//for right now lets have a working version so lets just have the end tile be top right corner and below in the character create it sets the spawn to 0,0 no bosses yet just a working game
		// first
		dungeon[0][dungeon[0].length -1] = new ExitTile(0,dungeon[0].length -1);
		/**
		// Swap method
